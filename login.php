    ...
    <div class="container pt-5">
        ...
        if ($_SERVER["REQUEST_METHOD"] === 'POST') {
            ...
            if ($password_length = 0) {
                $errors[] = 'A jelszó megadása kötelező!<br>';
            }
            ...
            if (count($errors) > 0) {
                ...
                mysqli_query($connection, "INSERT INTO `users` (`name`,`email`,`password`) VALUES ('{$_POST["name"]}','{$_POST["email"]}','{$_POST["hashpass"]}',)");
        ...
        <div class="row">
            ...
            <form method="POST" action="" class="row g-3">
                <div class="col-md-12">
                    ...
                    <input type="email" class="form-control" id="inputEmail" placeholder="Kérjük adja meg az email címét...">
                </div>
                <div class="col-md-12">
                    <label for="inputPassword" class="form-label">Jelszó</label>
                    <input type="password" class="form-control" id="inputPassword" placeholder="Adja meg a jelszavát...">
                </div>
                <div class="col-12">
                    <button type="submit" class="btn btn-success" name="submitted">Belépés</button>
                </div>
            </form>
